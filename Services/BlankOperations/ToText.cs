...
namespace DecimalToText
{
    class ToText
    {
        ...
        public ToText(Decimal number, CurrencyInfo currency)
        {
            InitializeClass(number, currency, String.Empty, "only", "فقط", "لا غير");
        }

        public ToText(Decimal number, CurrencyInfo currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
