...
{
    public partial class frmSaleInvAccountsCopy : Form 
    {
        ...
        public frmSaleInvAccountsCopy()
        {
            InitializeComponent();
        }

        public frmSaleInvAccountsCopy(SqlConnection conn)
        {
            InitializeComponent();
            connection = conn;
        ...
        public frmSaleInvAccountsCopy(IPosTransaction posTransaction, SqlConnection conn, bool bDuplicate, int iIsGift, int iLanForInv, int isItFromShowJour)
        {
            InitializeComponent();
        ...
        public frmSaleInvAccountsCopy(string sTransactionId, SqlConnection conn)
        {
            InitializeComponent();
        ...
        private void frmSaleInvAccountsCopy_Load(object sender, EventArgs e) 
        {
            ...
            param[28] = new ReportParameter("CopyName", "Accounts Copy");
