...
namespace Microsoft.Dynamics.Retail.Pos.Services
{
    ...
    public sealed class CashDrawerProxy : ICashDrawer
    {
        ...
        public bool DrawerOpen()
        {
            if (FiscalPrinter.FiscalPrinter.Instance.FiscalPrinterEnabled())
            {
                return FiscalPrinter.FiscalPrinter.Instance.DrawerOpen();
            }
        ...
        public bool CapStatus()
        {
            if (FiscalPrinter.FiscalPrinter.Instance.FiscalPrinterEnabled())
            {
                return FiscalPrinter.FiscalPrinter.Instance.CapStatus();
            }
        ...
        { 
            ...
            return this.cashDrawers[Peripherals.InternalApplication.Shift.CashDrawer];
        }
