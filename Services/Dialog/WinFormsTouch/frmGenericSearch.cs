...
namespace Microsoft.Dynamics.Retail.Pos.Dialog.WinFormsTouch
{
    ...
    /// </summary>
	public class frmGenericSearch : frmTouchBase
    {
        ...
        public frmGenericSearch(System.Data.DataTable dataTable, DataRow selectedRow, string title) : this()
        {
            if (dataTable == null)
